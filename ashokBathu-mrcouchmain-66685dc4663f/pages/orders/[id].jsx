      ...
      >
        ...
        <FlexBox justifyContent={width < breakpoint ? "center" : "flex-end"}>
          <Typography
            ...
            bgcolor="primary.light"
          >
            Estimated Delivery Date <b>{format(new Date(order.createdAt), "MMM dd, yyyy")}</b>
          </Typography>
        </FlexBox>
      </Card>
      ...
      >
        ...
        >
          <FlexBox className="pre" m={0.75} alignItems="center">
            ...
            <Typography fontSize={14}>{order.orderId}</Typography>
          </FlexBox>
      ...
      <Grid container spacing={3}>
        <Grid item lg={6} md={6} xs={12}>
          ...
          >
            ...
            {order.store_customer.customerName}
            
            </Paragraph>
            <Paragraph fontSize={14} my={0}>
            {order.store_customer.customerMobile}
           
            </Paragraph>
            <Paragraph fontSize={14} my={0}>
            {order.store_customer.customerEmail}
            </Paragraph>
            <Paragraph fontSize={14} my={0}>
            
              {order.store_customer.customerAddress}
            </Paragraph>
          </Card>
        </Grid>
        ...
        <Grid item lg={6} md={6} xs={12}>
          ...
          >
            ...
            <Typography fontSize={14}>Paid by Credit/Debit Card/cash</Typography>
          </Card>
        </Grid>
      </Grid>
    </CustomerDashboardLayout>
...
export const getStaticProps = async ({ params }) => {
  const order = await api.getOrders(String(params.id));
  return {
    props: {
      order,
    },
