      ...
      <Container>
        ...
        <Stack spacing={6} my={6}>
          ...
          <Section3
            ...
            products={props?.furnitureProductsOneSofa}
          ...
          <Section3
            ...
            products={props?.furnitureProductsTwoSofa}
            description="Tall blind but were, been folks not the expand"
          />

          {/* ALL PRODUCTS AREA */}
          {/* <Section4 products={props?.furnitureProductsOneSofa} />
          <Section4 products={props?.furnitureProductsTwoSofa} /> */}
          <Section4 products={props?.furnitureProductsThreeSofa} />
...
export const getStaticProps = async () => {
  ...
  const furnitureProductsOneSofa = await api.getFurnitureOneSofas();
  const furnitureProductsTwoSofa = await api.getFurnitureTwoSofas();
  const furnitureProductsThreeSofa = await api.getFurnitureThreeSofas();
  ...
  return {
    props: {
      ...
      topNewProducts,
      mainCarouselData,
      furnitureProductsOneSofa,
      furnitureProductsTwoSofa,
      furnitureProductsThreeSofa,
      topSellingProducts,
    },
  };
};
