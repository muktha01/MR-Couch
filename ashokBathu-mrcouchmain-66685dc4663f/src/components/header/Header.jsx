...
import { Clear, KeyboardArrowDown, PersonOutline, Search, SearchOffOutlined } from "@mui/icons-material";
      ...
      <HeaderWrapper className={clsx(className)}>
        <StyledContainer>
          <FlexBetween width="100%">
            ...
            {/* RIGHT CONTENT - LOGIN, WISHLIST, CART, SEARCH BUTTON */}
      ...
      <StyledContainer>
       ...
       <FlexBox  alignItems="center" >
        ...
        <FlexBox mr={2} minWidth="170px" alignItems="center">
          <Link href="/">
            <Image height={60} src="/assets/images/MrCouchLogoWhite.png" alt="logo" />
            {/* <Image height={200} color="blue" src="/assets/images/Mr.Couch_Black.png" alt="logo" /> */}
          </Link>
        ...
        {/* LOGIN, WISHLIST AND CART BUTTON */}
